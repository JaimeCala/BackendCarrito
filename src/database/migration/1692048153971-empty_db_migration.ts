...
export class emptyDbMigration1692048153971 implements MigrationInterface {
    name = 'emptyDbMigration1692048153971'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "login" ("idlogin" SERIAL NOT NULL, "username" character varying, "password" character varying, "fecha" date, "hora" TIME, "reset_password_token" uuid, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "idusuario" integer, CONSTRAINT "UQ_ccfccb4f5568d52259432893217" UNIQUE ("reset_password_token"), CONSTRAINT "PK_50ba318012b060e609beead047a" PRIMARY KEY ("idlogin"))`);
        ...
        await queryRunner.query(`CREATE TABLE "compra" ("idcompra" SERIAL NOT NULL, "precio_compra_uni" double precision NOT NULL, "precio_compra_total" double precision NOT NULL, "tipo_comprobante" character varying(20), "num_comprobante" character varying(20), "cantidad_ingreso" integer NOT NULL, "observacion" character varying(150), "fecha" date NOT NULL, "hora" TIME NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "idproveedor" integer, "idproducto" integer, CONSTRAINT "PK_754f1ce4c972617d36462439969" PRIMARY KEY ("idcompra"))`);
        await queryRunner.query(`CREATE TABLE "producto" ("idproducto" SERIAL NOT NULL, "nombre" character varying(100) NOT NULL, "descripcion" character varying(100) NOT NULL, "stock" integer NOT NULL, "minimo" integer NOT NULL, "maximo" integer, "vencimiento" character varying, "precio" double precision NOT NULL, "disponible" character varying(15), "estado" character varying(10) NOT NULL DEFAULT 'ACTIVO', "peso" double precision, "fecha" date, "oferta" character varying(3) DEFAULT 'NO', "porcentaje" double precision DEFAULT 0, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "idcategoria" integer, CONSTRAINT "UQ_d86d179360134b4b74bda750664" UNIQUE ("nombre"), CONSTRAINT "PK_9a87a8b8af75084e6b5a6a8d7da" PRIMARY KEY ("idproducto"))`);
        await queryRunner.query(`CREATE TABLE "pedidoproducto" ("idpedidoproducto" SERIAL NOT NULL, "cantidad" integer NOT NULL, "precio_uni" double precision, "precio_total" double precision, "oferta" character varying, "porcentaje_des" double precision, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "idpedido" integer, "idproducto" integer, CONSTRAINT "PK_3c6e641f613f6ba51ced39c4409" PRIMARY KEY ("idpedidoproducto"))`);
        ...
        await queryRunner.query(`CREATE TABLE "pedido" ("idpedido" SERIAL NOT NULL, "comentario" character varying(250), "direccion" character varying(250), "precio" double precision, "latitud" character varying(100) NOT NULL, "longitud" character varying(100) NOT NULL, "fecha" date NOT NULL, "hora" TIME NOT NULL, "nombrefilepdf" character varying(50), "linkfilepdf" character varying, "estado" character varying(10) NOT NULL DEFAULT 'ESPERA', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "idcliente" integer, CONSTRAINT "PK_70726b8cb4f3ce27a06bd47b93c" PRIMARY KEY ("idpedido"))`);
        ...
        await queryRunner.query(`CREATE TABLE "banners" ("idbanner" SERIAL NOT NULL, "nombreimgbanner" character varying(50) NOT NULL, "linkimgbanner" character varying NOT NULL, "estado" character varying(10) DEFAULT 'ACTIVO', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0b561fca99996ab2fd225b49012" PRIMARY KEY ("idbanner"))`);
